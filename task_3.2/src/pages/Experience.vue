    ...
    data() {
        return {
            experienceList: [
                {
                    id: 1,
                    mainTitle: 'Senior Web Developer',
